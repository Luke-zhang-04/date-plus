...
var G = {
    ...
    Y = function (e, t) {
        return -1 * Math.round((e.getTime() - t.getTime()) / L)
    },
    ee = function (e, t) {
    ...
    ue = (function (e) {
        ...
        function s() {
            return W(this, s), i.apply(this, arguments)
        }
        return (
            (n = s),
            (o = [
                ...
                },
                {
                    key: "getWordDay",
                    value: function () {
                        return G[this.getDay()]
                    },
                },
                {
                    key: "getWordMonth",
                    value: function () {
                        return K[this.getMonth()]
                    },
                },
                {
                    key: "getElapsedDays",
...
;(exports.DatePlus = ue),
    ...
    (exports.getDateValues = function (e) {
        ...
        for (var s = e.split(n), a = t.split(":"), c = {}, f = 0; f < 3; f++) {
            var p = Q[a[f]]
            c[p] = Number(s[f])
        }
        return c
    }),
    (exports.getElapsedDays = Y),
    (exports.getElapsedHours = ee),
    (exports.getElapsedMinutes = te),
    (exports.getElapsedMs = ne),
    (exports.getElapsedSeconds = re),
    (exports.getElapsedString = oe),
    ...
    (exports.secondsToMinutes = f),
    (exports.secondsToMs = a),
    (exports.secsToDays = v),
    (exports.secsToHrs = p),
    (exports.secsToMins = c),
    (exports.secsToMs = s),
