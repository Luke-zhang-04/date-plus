...
const e = (e) => ({ms: e % 1e3, seconds: (e - (e % 1e3)) / 1e3}),
    ...
    Z = (e) => 24 * e,
    j = Z,
    q = {hrsPerDay: 24, minsPerHr: 60, secsPerMin: 60, msPerSec: 1e3},
    z = {
        0: "Sunday",
        1: "Monday",
        2: "Tuesday",
    ...
    U = (e) => z[e],
    V = (e) => B[e],
    X = (e, t) => -1 * Math.round((e.getTime() - t.getTime()) / 864e5),
    Y = (e, t) => -1 * Math.round((e.getTime() - t.getTime()) / 36e5),
    $ = (e, t) => -1 * Math.round((e.getTime() - t.getTime()) / 6e4),
    ...
    te = (e, t, r = "about") => {
        ...
        return n < 6e4
            ? ((o = Math.round(n / 1e3)),
              "".concat(o, " second").concat(1 === o ? "" : "s", " ago"))
            : n < 36e5
            ? ((o = Math.round(n / 6e4)),
              "".concat(o, " minute").concat(1 === o ? "" : "s", " ago"))
            : n < 864e5
            ? ((o = Math.round(n / 36e5)),
              "".concat(o, " hour").concat(1 === o ? "" : "s", " ago"))
            : n < s
            ? ((o = Math.round(n / 864e5)),
              ""
                  .concat(r, " ")
                  .concat(o, " day")
                  .concat(1 === o ? "" : "s", " ago"))
...
export {
    ...
    R as getDateValues,
    X as getElapsedDays,
    Y as getElapsedHours,
    $ as getElapsedMinutes,
    ee as getElapsedMs,
    ...
    f as minutesToHours,
    l as minutesToMs,
    p as minutesToSeconds,
    B as monthsReference,
    o as msToDays,
    n as msToHours,
    a as msToHrs,
    r as msToMins,
