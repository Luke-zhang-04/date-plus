...
;(e.msToSecs = (e) => ({ms: e % 1e3, seconds: (e - (e % 1e3)) / 1e3})),
    ...
    (e.msToDays = (e) => {
        const s = (e % 1e3) % 1e3,
            t = ((e - (e % 1e3)) / 1e3) % 60,
            r = ((e - 1e3 * t - s) / 6e4) % 60,
            n = ((e - 1e3 * r * 60 - 1e3 * t - s) / 36e5) % 24
        return {
            ms: s,
            seconds: t,
            minutes: r,
            hours: n,
            days: (e - 1e3 * n * 60 * 60 - 1e3 * r * 60 - 1e3 * t - s) / 864e5,
        }
    }),
    (e.secsToMs = (e) => 1e3 * e),
...
class s extends e {
    constructor() {
        super(...arguments),
            (this.getElapsedDays = (e) => -1 * Math.round((this.getTime() - e.getTime()) / s.t))
    }
}
;(s.t = 864e5), (s.getElapsedDays = (e, t) => -1 * Math.round((e.getTime() - t.getTime()) / s.t))
class t extends s {}
...
class r extends t {
    constructor() {
        super(...arguments),
            ...
            (this.getWordDay = () => r.u[this.getDay()]),
            (this.getWordMonth = () => r.o[this.getMonth()])
    }
}
;(r.u = {
    0: "Sunday",
    ...
    (r.getDateValues = (e, s = "y:m:d", t = "auto") => {
        ...
        const u = e.split(n),
            ...
            o = {}
        for (let e = 0; e < 3; e++) {
            o[r.i[a[e]]] = Number(u[e])
        }
        return o
    }),
    (r.getWordDay = (e) => r.u[e]),
    (r.getWordMonth = (e) => r.o[e])
export default r
export {r as DatePlus}
