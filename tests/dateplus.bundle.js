...
function _wrapNativeSuper (Class) /* istanbul ignore next */ {
    var _cache = typeof Map === "function" ? new Map() : undefined 

    _wrapNativeSuper = function _wrapNativeSuper (Class) /* istanbul ignore next */ {
...
function _construct (Parent, args, Class) /* istanbul ignore next */ {
    if (_isNativeReflectConstruct()) {
        _construct = Reflect.construct 
    } else {
        _construct = function _construct (Parent, args, Class) /* istanbul ignore next */ {
            var a = [null] 
...
function _isNativeFunction (fn) /* istanbul ignore next */ {
...
module.exports = (function (modules) /* istanbul ignore next */  {
